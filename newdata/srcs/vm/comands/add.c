...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/08 15:54:53 by rywisozk          #+#    #+#             */
/*   Updated: 2019/07/08 15:55:38 by rywisozk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	get_arg2(t_game *game, t_oper *op)
{
	...
	{
		oper->arg2_type = parse_args(game->arena[oper->arg_byte_pose], 1);
...
void		apply_add(t_carriage *carr, t_oper *oper)
{
	int arg1;
	int arg2;
