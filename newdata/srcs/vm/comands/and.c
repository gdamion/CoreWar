...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/08 15:55:05 by rywisozk          #+#    #+#             */
/*   Updated: 2019/07/08 15:55:46 by rywisozk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		apply_and(t_carriage *carr, t_game *game, t_oper *oper)
{
	int arg1;
	int arg2;
	...
	if (oper->arg1_type == T_REG)
		...
		arg1 = get_arg_value(game, carr->curr_position + arg1 % IDX_MOD, 4);
	if (oper->arg2_type == T_REG)
		arg2 = carr->regs[oper->arg2 - 1];
	else if (oper->arg2_type == T_IND)
		arg2 = get_arg_value(game, carr->curr_position + arg2 % IDX_MOD, 4);
	if ((arg1 & arg2) == 0)
		carr->carry = 1;
	else
		carr->carry = 0;
