...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/08 15:56:07 by rywisozk          #+#    #+#             */
/*   Updated: 2019/07/08 15:56:09 by rywisozk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		apply_ld(t_carriage *carr, t_game *game, t_oper *oper)
{
	t_oper	*tmp;
	int		arg1;
